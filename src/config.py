...
APP_VERSION = "v2.11 Premium Lane Cards"
...
LANE_QUERY_MAP = {
    "B7-H4 / VTCN1": PRESET_QUERIES[0],
    "CDH6": PRESET_QUERIES[1],
    "Alzheimer's / ApoE4": PRESET_QUERIES[2],
    "Bone / Siglec-15": PRESET_QUERIES[3],
}

LANE_DISPLAY_NAMES = {
    "B7-H4 / VTCN1": "B7-H4",
    "CDH6": "CDH6",
    "Alzheimer's / ApoE4": "Alzheimer's / ApoE4",
    "Bone / Siglec-15": "Bone / Siglec-15",
}

LANE_CAPTIONS = {
    "B7-H4 / VTCN1": "B7-H4 / VTCN1 ADC and oncology registry intelligence.",
    "CDH6": "CDH6 / cadherin-6 ADC and ovarian-relevant registry intelligence.",
    "Alzheimer's / ApoE4": "Alzheimer's, ApoE4, biomarker, and neurodegeneration intelligence.",
    "Bone / Siglec-15": "Bone disease, Siglec-15, and skeletal biology intelligence.",
}

LANE_SCAN_OPTIONS = {
    "All 4 lanes": {
        "lanes": list(TARGET_LANES.keys()),
        "queries": PRESET_QUERIES,
        "caption": "Full executive scan across CDH6, B7-H4, Alzheimer's/ApoE4, and Bone/Siglec-15."
    },
    "CDH6": {
        "lanes": ["CDH6"],
        "queries": [PRESET_QUERIES[1]],
        "caption": "Focused CDH6 / cadherin-6 ADC and ovarian-relevant registry scan."
    },
    "B7-H4": {
        "lanes": ["B7-H4 / VTCN1"],
        "queries": [PRESET_QUERIES[0]],
        "caption": "Focused B7-H4 / VTCN1 ADC and oncology registry scan."
    },
    "Alzheimer's / ApoE4": {
        "lanes": ["Alzheimer's / ApoE4"],
        "queries": [PRESET_QUERIES[2]],
        "caption": "Focused Alzheimer's, ApoE4, biomarker, and neurodegeneration scan."
    },
    "Bone / Siglec-15": {
        "lanes": ["Bone / Siglec-15"],
        "queries": [PRESET_QUERIES[3]],
        "caption": "Focused bone disease, Siglec-15, and skeletal biology scan."
    },
}
